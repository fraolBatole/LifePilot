...
class CareerAgent(BaseAgent):
    ...
    system_prompt = (
        ...
        "You also have a schedule_task tool. When a user asks for recurring tasks "
        "(e.g., 'find me jobs every morning at 7am'), use schedule_task to set up "
        "a cron job with the appropriate schedule and task description. Convert "
        "natural language schedules to 5-field cron expressions.\n\n"
